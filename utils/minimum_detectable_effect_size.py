...
# Author: Dan (okeeffed090@gmail.com), then hacked up by David (dbendet@gmail.com)
...
if __name__ == '__main__':
    ...
    # historical_data_path = '/Users/dbendet/src/github.com/Shopify/misc/end_of_trial_exp/data/all_trials_auto_installed_july_2022.csv'
    sig_level = 0.05
    power = 0.8
